...
Special thanks to **@snaterst** \(on the forum\) for providing the vise setup picture, **@Dusty.Tools** \(find him on Instagram\) for the T-tracks setup picture, **@gmack** for his excellent feeds and speeds worksheet, **@Hooby** for the nice Janka wood hardness database included in the worksheets, **@WillAdams** and **@luc.onthego** for proofreading and suggesting lots of good improvement ideas.
